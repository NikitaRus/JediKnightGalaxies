...
/*
Code for the individual item type classes.
*/
...
IWeaponItem* IWeaponItemInstance::FillBaseData()
{
	return NULL;
}
...
IArmorItem* IArmorItemInstance::FillBaseData()
{
	return NULL;
}
...
IClothingItem* IClothingItemInstance::FillBaseData()
{
	return NULL;
}
...
ICrystalItem* ICrystalItemInstance::FillBaseData()
{
	return NULL;
}
...
IConsumableItem* IConsumableItemInstance::FillBaseData()
{
	return NULL;
}
...
IAmmoItem* IAmmoItemInstance::FillBaseData()
{
	return NULL;
}